...
const NotFound = ({
    ...
    useLogError(ErrorCodes.notFound);
        ...
        >
            <div className="max-w-3xl w-full">
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
                    <div className="shrink-0 md:-mr-24 md:-mt-18 md:relative md:z-5">
                    ...
                    <div className="flex-1 bg-white dark:bg-mono-800 rounded-xl md:rounded-2xl shadow-lg p-6 md:p-8 text-center md:text-left">
                        <h1 className="text-3xl md:text-4xl font-bold font-sans mb-4 flex items-center justify-center md:justify-start gap-3 text-mono-900 dark:text-mono-100">
                            <FontAwesomeIcon icon={faCompass} className="text-primary-500 animate-pulse" />
                            {title}
                        </h1>
                        ...
                        <div className="flex justify-center md:justify-start gap-4">
                            <Button shape="square" className="w-full md:w-auto px-5 py-3 z-20" onClick={() => navigate("/")}>
                                Go Home
                            </Button>
                        </div>
                    </div>
