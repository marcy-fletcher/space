...
type CompactInputSelectProps<TFieldValues extends FieldValues = FieldValues> = {
...
const CompactInputSelect = <TFieldValues extends FieldValues = FieldValues>({
                                                                                id,
                                                                                label,
                                                                                icon,
                                                                                error,
                                                                                ...
                                                                                required,
                                                                                ...selectProps
                                                                            }: CompactInputSelectProps<TFieldValues>) => {
...
export default CompactInputSelect;
